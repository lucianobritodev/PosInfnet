		...
		<form:form action="/reserva/salvar" method="post" modelAttribute="reserva">
		  <div class="row mb-4">
			  ...
			  <div class="form-group col-sm-4">
			    ...
			    <form:input type="datetime-local" id="dataReserva" class="form-control" path="dataReserva" requered="true" pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}" />
			  </div>
			  
			  <div class="form-group col-sm-4">
			    <label class="form-label" for="dias">Dias Reservados:</label>
			    <form:input type="number" id="dias" class="form-control" path="diasReservados" min="1" requered="true" />
			  </div>
			  <div class="form-group col-sm-4">
				<label class="form-label" for="status">Status:</label>
				<form:select id="status" path="status" class="form-select" required="true" >
		  ...
		  <div class="row mb-4">
			  <div class="form-group">
				...
				<form:textarea id="descricao" class="form-control" rows="6" path="descricao" value="${ reserva.descricao }" />
			  </div>
		  </div>
		  ...
		  <div class="row mb-4">
			<div class="d-flex">
			  ...
			  <a  href="/reserva/listar" class="btn btn-secondary"><i class="bi bi-x-lg"></i>&nbsp;Cancelar</a>&nbsp;
